...
class TestCredentials(unittest.TestCase):
	...
	def setUp(self):
		...
		'''
		self.new_credential = Credential('base commander','Facebook','Timmy','pswd3550')
	...
	def test_display_credentials(self):
		...
		'''
		self.new_credential.save_credentials()
		twitter = Credential('Timmy','Twitter','TIm','pswd100')
		twitter.save_credentials()
		gmail = Credential('Tim','Gmail','timnduch','pswd200')
	...
	def test_find_by_site_name(self):
		...
		'''
		self.new_credential.save_credentials()
		twitter = Credential('Timmy','Twitter','Tim','pswd3550')
		twitter.save_credentials()
